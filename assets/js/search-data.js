    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-healthsenseai-self-heal-engine",
          title: 'HealthSenseAI Self-Heal Engine',
          description: "Fleet-scale monitoring and autonomous remediation for Windows endpoints.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/1_project/";
            },},{id: "projects-ple-echo-ai-onboarding-agent",
          title: 'PLE Echo — AI Onboarding Agent',
          description: "Fine-tuned internal knowledge assistant for faster onboarding.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/2_project/";
            },},{id: "projects-fire-detection-amp-control-system",
          title: 'Fire Detection &amp;amp; Control System',
          description: "Real-time computer vision system published in Springer.",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ramendra-k", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ramendrakumar", "_blank");
        },
      },{
      id: 'light-theme',
